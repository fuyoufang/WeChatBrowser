 ...
 *  @return 管理器实例
 */
    static func sharedInstance() -> TIMFriendshipManager {
        fatalError()
    }
 ...
 *  @return 0 发送请求成功
 */
    func getSelfProfile(succ: TIMGetProfileSucc, fail: TIMFail) -> Bool {
        fatalError()
    }
 ...
 *  @return 0 发送请求成功
 */
    func getFriendList(succ: TIMFriendArraySucc, fail: TIMFail) -> Bool {
        fatalError()
    }
 ...
 *  @note 缓存数据来自于上一次调用getFriendList，请确保已调用了获取好友列表方法
 */
    func queryFriendList() -> [TIMFriend]? {
        fatalError()
    }
